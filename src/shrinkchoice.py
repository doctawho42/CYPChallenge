...
def main():
    ...
    print("""
  Две оговорки, и обе существенные. Оценки k5 сами имеют разброс, а числа выше посчитаны
  так, будто он нулевой; реальный выигрыш меньше этой границы настолько, насколько k5
  неточен. И на 2D6 оценка отрицательна, то есть тест по этому ферменту, возможно, сдвинут
  ВНИЗ, --- наша общая вилка от +0.1 до +0.6 этого не предполагает вовсе, и одно из двух
  измерений тут неверно.""")
