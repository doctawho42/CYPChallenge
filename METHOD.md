...
The code is at the repository root; `verify/README.md` is the journal, numbered to item 304, and is
...
What this project offers is methodological rather than architectural: an instrument for telling an effect from a floor, pointed at its own ideas, which then closed most of them. The journal, `verify/README.md`, runs to item 304; negative results are the majority.
